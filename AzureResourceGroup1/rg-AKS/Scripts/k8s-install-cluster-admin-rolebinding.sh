...
helm package "$MY_PATH/../Resources/k8s-cluster-admin" --destination "$MY_PATH/../Resources"
...
az acr helm push -n "${acrName}" "$MY_PATH/../Resources/k8s-cluster-admins-1.0.0.tgz" --force #--username a03158e9-58f5-4e5e-b11b-b5a2df77c661 --password FiS+yQNCI7GrX4jJ5ydyZOH9XmbCFCSBN70SdiwwtWg=
